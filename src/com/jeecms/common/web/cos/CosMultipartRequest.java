 ...
 *
 * @see com.jeecms.common.web.cos.MultipartParser
 * 
 * @author Jason Hunter
...
public class CosMultipartRequest {
   ...
   * @exception java.io.IOException if the uploaded content is larger than 1 Megabyte
   ...
   * @exception java.io.IOException if the uploaded content is larger than
