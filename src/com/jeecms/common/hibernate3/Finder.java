...
public class Finder {
	 ...
	 * @param paramMap
	 * @return
	 * @see Query#setProperties(java.util.Map)
	 */
	 ...
	 * @param type
	 * @return
	 * @see Query#setParameterList(String, java.util.Collection, Type))
	 */
	 ...
	 * @param vals
	 * @return
	 * @see Query#setParameterList(String, java.util.Collection)
	 */
